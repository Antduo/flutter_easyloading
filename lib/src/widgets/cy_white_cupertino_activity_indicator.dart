...
class CYWhiteCupertinoActivityIndicator extends StatefulWidget {
  /// Creates an iOS-style activity indicator that spins clockwise.
  const CYWhiteCupertinoActivityIndicator({
    Key key,
    this.animating = true,
  ...
  /// to 1.0.
  const CYWhiteCupertinoActivityIndicator.partiallyRevealed({
    Key key,
    this.radius = _kDefaultIndicatorRadius,
    this.progress = 1.0,
  })  : assert(radius != null),
  ...
  @override
  _CYWhiteCupertinoActivityIndicatorState createState() => _CYWhiteCupertinoActivityIndicatorState();
}

class _CYWhiteCupertinoActivityIndicatorState extends State<CYWhiteCupertinoActivityIndicator> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(CYWhiteCupertinoActivityIndicator oldWidget) {
...
const List<int> _alphaValues = <int>[47, 47, 47, 47, 64, 81, 110, 130, 150, 180, 220, 255];
